...
public class TechPendingJobsAdapter extends RecyclerView
        .Adapter<TechPendingJobsAdapter
        .DataObjectHolder> {
   Context cntext;
   ApplicationController obj;
    ...
    public TechPendingJobsAdapter(Context cnt, List<TechPendingListItems> myDataset) {
        mDataset = myDataset;
        cntext=cnt;
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.pending_req_row, parent, false);
