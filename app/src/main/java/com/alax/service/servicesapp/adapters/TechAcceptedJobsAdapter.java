...
public class TechAcceptedJobsAdapter extends RecyclerView
        .Adapter<TechAcceptedJobsAdapter
        .DataObjectHolder> {
   Context cntext;
   ApplicationController obj;
    ...
    public TechAcceptedJobsAdapter(Context cnt, List<TechAcceptListItems> myDataset) {
        mDataset = myDataset;
        cntext=cnt;
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.accept_req_row, parent, false);
