...
public class TechPendingRequestActivity extends AppCompatActivity implements TechPendingJobListInterface {
    ...
    TextView headertxt;
    TechPendingJobListRepositry TPJRObj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TPJRObj=new TechPendingJobListRepositry(TechPendingRequestActivity.this,RetrofitRequrest.ProgressForDriver(TechPendingRequestActivity.this),this);
        headertxt=(TextView) findViewById(R.id.headertxt);
        headertxt.setText("Pending Jobs");
        ...
        mLayoutManager = new LinearLayoutManager(TechPendingRequestActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    @Override
    public void getTechJobPendigSuccess(List<TechPendingListItems> msg) {
        mAdapter = new TechPendingJobsAdapter(this,msg);
        mRecyclerView.setAdapter(mAdapter);
    }

    @Override
    public void SignupFailed(String msg) {
    Toast.makeText(TechPendingRequestActivity.this,""+msg,Toast.LENGTH_LONG).show();
