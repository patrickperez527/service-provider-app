...
public class EnquiryHistoryActivity extends AppCompatActivity implements TechPendingJobListInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TPJRObj=new TechPendingJobListRepositry(EnquiryHistoryActivity.this,RetrofitRequrest.ProgressForDriver(EnquiryHistoryActivity.this),this);
        ...
        mLayoutManager = new LinearLayoutManager(EnquiryHistoryActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    Toast.makeText(EnquiryHistoryActivity.this,""+msg,Toast.LENGTH_LONG).show();
