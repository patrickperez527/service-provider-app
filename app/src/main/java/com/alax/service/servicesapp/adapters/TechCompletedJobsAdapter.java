...
public class TechCompletedJobsAdapter extends RecyclerView
        .Adapter<TechCompletedJobsAdapter
        .DataObjectHolder> {
   Context cntext;
   ApplicationController obj;
    Typeface sonictonicfonts;
    private static String LOG_TAG = "CategoryRecyclerViewAdapter";
    private List<TechAcceptListItems> mDataset;
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        public DataObjectHolder(View itemView) {
            ...
            wrks = (TextView) itemView.findViewById(R.id.wrks);
            pro_area_name = (TextView) itemView.findViewById(R.id.pro_area_name);
            servicename = (TextView) itemView.findViewById(R.id.servicename);
            cadres = (TextView) itemView.findViewById(R.id.cadres);
    ...
    public TechCompletedJobsAdapter(Context cnt, List<TechAcceptListItems> myDataset) {
        mDataset = myDataset;
        cntext=cnt;
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.complete_req_row, parent, false);
...
//                obj.setcId(mDataset.get(position).getC_id());
//                cntext.startActivity(new Intent(cntext, AceeptedDetailReqActivity.class));
            }
        });
    }

    public void addItem(TechAcceptListItems dataObj, int index) {
